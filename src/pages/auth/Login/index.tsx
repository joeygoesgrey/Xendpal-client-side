...
const faqData: FAQItem[] = [
  {
    question: "What is Xendpal?",
    answer:
      "Xendpal is a platform designed to streamline static file management, allowing developers and designers to efficiently manage, host, and embed static files such as images and videos.",
  },
  {
    question: "How does Xendpal reduce storage costs?",
    answer:
      "Xendpal offers optimized storage solutions and centralized hosting, which helps reduce the overall cost of storing and managing your static files.",
  },
  {
    question: "Can Xendpal improve file upload speeds?",
    answer:
      "Yes, Xendpal uses high-speed concurrent uploads and advanced file chunking technology to ensure fast and efficient file uploads.",
  },
  {
    question: "What is the Xendpal CLI?",
    answer:
      "The Xendpal CLI is a command-line interface tool that allows developers to perform CRUD operations directly from the terminal, integrating seamlessly into their development workflow.",
  },
  {
    question: "Is Xendpal secure?",
    answer:
      "Absolutely. Xendpal employs robust security measures, including secure direct links, to ensure your data is protected and accessible only to authorized users.",
  },
  {
    question: "How can I get started with Xendpal?",
    answer:
      "Getting started with Xendpal is easy. Simply sign up on our website, and you’ll be able to start managing, hosting, and embedding your static files in no time.",
  },
];
  ...
  return (
    <div className="bg-white text-black py-20">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="text-left max-w-4xl my-7 mx-auto">
          {faqData.map((faq, index) => (
            <div key={index} className="mb-6">
              <h3
                className="text-xl flex justify-between font-semibold mb-2 text-green-600 cursor-pointer"
        ...
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-8">
          ...
          <div className="flex-shrink-0">
            <div className="relative">
              <img
                src="https://via.placeholder.com/300x200.png?text=Video"
                alt="Video"
                className="rounded-md w-full md:w-96 h-auto"
              />
              <div className="absolute inset-0 flex justify-center items-center">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm-1-11.293l4 2.5a1 1 0 010 1.586l-4 2.5A1 1 0 018 12.5v-5a1 1 0 011-1z"
                    clipRule="evenodd"
                  />
                </svg>
              </div>
          ...
          {/* Problem/Solution Section TEXT SECTION */}
          <div className="flex-grow">
            <p className="text-gray-500 text-2xl mb-4">
              Sharing or embedding files through links is a major challenge for
              web developers and designers. Traditional cloud storage solutions
              are not built with this need in mind, often lacking the necessary
              features for seamless integration.
            </p>
            <p className="text-gray-700 mb-4">
              Imagine working on a project where you need to embed hundreds of
              images and videos. Slow upload speeds, disorganized folders, and
              non-embeddable links slow down your workflow. Collaborating with
              remote teams and keeping assets consistent across environments
              adds to the frustration.
            </p>
            <p className="text-gray-700">
              Enter Xendpal — designed to make sharing and embedding files
              through links effortless. Xendpal offers high-speed concurrent
              uploads, and dedicated folder structures tailored for developers
              and designers. Save on storage and CDN costs while enjoying faster
              deployments, seamless collaboration, and consistent asset
              management across all environments, all with the convenience of
              our CLI tool.
            </p>
          </div>
        </div>
...
const BenefitSection: React.FC = () => {
  return (
    <>
      {/* Xendpal Benefit Section */}
      <section
        className="bg-white text-black py-20"
        id="XENDPAL_BENEFIT_SECTION"
      >
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-12">Why Xendpal</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center">
              <svg
                ...
                viewBox="0 0 20 20"
              >
                <path d="M10 20a10 10 0 100-20 10 10 0 000 20zm1-14.5v4h4v-4h-4zM9 14H5v-4h4v4z" />
              </svg>
              <h3 className="text-xl font-semibold mb-2">
                Reduced Storage Cost
              </h3>
              <p className="text-gray-600">
                Save on storage expenses by efficiently managing and hosting
                your static files. This is made possible through our centralized
                hosting and optimized storage solutions.
              </p>
            </div>
            <div className="flex flex-col items-center">
              <svg
              ...
              <h3 className="text-xl font-semibold mb-2">
                Reduced File Latency
              </h3>
              <p className="text-gray-600">
                Experience faster file access and lower latency with our
                high-speed concurrent uploads and advanced file chunking
                technology, ensuring efficient file handling and quick access.
              </p>
            </div>
            <div className="flex flex-col items-center">
              <svg
              ...
              <h3 className="text-xl font-semibold mb-2">
                Xendpal CLI for Seamless Developer Experience
              </h3>
              <p className="text-gray-600">
                Enhance your development workflow with our powerful CLI tool,
                allowing you to perform CRUD operations directly from your
                terminal. This feature integrates seamlessly into your
                development process, providing real-time progress indication and
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h2 className="text-3xl font-bold mb-4">
              Trusted by over 700 + registered users and 100 teams
            </h2>
            <a
              href="#customer-stories"
              className="text-teal-500 mb-8 inline-block"
            >
            ...
            <div className="space-y-4">
              {users.map((user, index) => (
                ...
                >
                  <p className="text-gray-600">{`${user.testimonial.text}`}</p>
          ...
          <div className="bg-xendpal text-white p-8 rounded-lg shadow-lg flex flex-col justify-center">
            <h2 className="text-3xl font-bold mb-4">Join Xendpal</h2>
            <p className="mb-8">
              Trusted by numerous developers and businesses to manage and
              protect their static files efficiently.
            </p>
            <a
              href={`${API_BASE_URL}/user/google_redirect`}
              className="animate__bounceInDown bg-xendpal flex justify-center border border-teal text-center text-black py-3 px-6 rounded-full "
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                id="google"
                className="h-6 my-auto mx-2"
              >
                <path
                  fill="#fbbb00"
    ...
    <>
      <section className="bg-white text-black py-20" id="about_xendpal">
        ...
        <p className="text-gray-600 mb-8 px-3 text-center">
          Xendpal brings everything—traditional files, cloud content, and web
          ...
          <div>
            <div className="space-y-4">
              <div className="border border-teal-500 rounded-lg p-4">
                <h3 className="text-xl font-semibold mb-2">
                  Get started with easy static file management
                </h3>
                <p className="text-gray-600">
              ...
              <div className="border border-teal-500 rounded-lg p-4">
                ...
                <p className="text-gray-600">
                  Xendpal provides room for all your content with customizable
                  folder structures.
                </p>
              </div>
              <div className="border border-teal-500 rounded-lg p-4">
                ...
                <p className="text-gray-600">
                  Make life easier for you and your clients with secure and
                  efficient file sharing.
                </p>
              </div>
              <div className="border border-teal-500 rounded-lg p-4">
                <h3 className="text-xl font-semibold mb-2">
                  Centralize your static assets
                </h3>
                <p className="text-gray-600">
                  Centralize, secure, and easily access your work from anywhere.
                </p>
              </div>
              <div className="border border-teal-500 rounded-lg p-4">
                <h3 className="text-xl font-semibold mb-2">
                ...
                <p className="text-gray-600">
                  Track, analyze, and optimize your content with Xendpal’s
                  intuitive tools such as the Xendpal command line interface
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 flex flex-col items-center">
          <div className="md:w-3/4 text-center">
            ...
            <p className="text-lg mb-8">
              Xendpal is a pioneering platform that revolutionizes static file
              management, allowing developers and designers to streamline file
              uploads, organize projects efficiently, and reduce costs. Achieve
              faster deployment, enhanced project structure, and cost savings on
            ...
            <div className="flex justify-center space-x-4">
              <a
                href={`${API_BASE_URL}/user/google_redirect`}
                className="bg-xendpal text-black py-3 px-8 rounded-full hover:bg-teal-600 flex animate__heartBeat"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
            ...
            {/* RESULTS CHECKMARK SECTION */}
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4 my-7">
              <div className="flex items-center space-x-2">
                <svg
                  className="w-5 h-4 text-green-600"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <span>Reduced Storage Cost</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg
                  className="w-5 h-4 text-green-600"
                ...
                <span>Reduced File Latency</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg
                  className="w-5 h-4 text-green-600"
                ...
                <span>Xendpal CLI for Seamless Developer Experience</span>
              </div>
            </div>
            {/* END OF RESULTS CHECKMARK SECTION */}
          </div>
          {/* TOP STORAGE BUCKETS SVG */}
          <div className="mt-10 md:mt-0">
            ...
            >
              <defs>
                <linearGradient
                  id="uuid-eb9161ae-d05a-4b98-bd77-bb52b0a075d2-570"
                  x1="-1211.56439"
                  y1="1173.41747"
                  x2="-1232.05939"
                  y2="1233.96496"
                ...
                <linearGradient
                  id="uuid-2da8b4cb-046d-4115-aa61-a56819df46ae-571"
                  x1="-1205.16237"
                  y1="1201.63341"
                  x2="-1209.90309"
                  y2="1203.23644"
                ...
                <linearGradient
                  id="uuid-b4e7c5f5-65fb-4e53-973e-8c028050d1e4-572"
                  x1="-1207.62209"
                  y1="1171.59629"
                  x2="-1185.12454"
                  y2="1231.53367"
              ...
              <path
                d="M428.43042,280.49091c-1-1-9-22-9-22l-19-1-8.69342,20.49606,36.69342,2.50394Z"
                fill="#ffb6b6"
              />
              <circle
                cx="401.47449"
              ...
              />
              <polygon
                points="449.93042 418.99091 458.93042 448.99091 434.93042 622.99091 418.68237 622.99091 409.93042 491.99091 399.93042 536.99091 450.93042 601.99091 437.93042 616.99091 364.43042 545.49091 365.93042 434.99091 371.93042 417.99091 449.93042 418.99091"
                fill="#2f2e41"
              />
              <path
                d="M422.91617,262.60004l-1.99759,.09842s-1.78607-15.93141-2.83408-16.881-2.94717,1.14641-2.94717,1.14641c0,0-8.23633-4.6003-8.48236-9.59424s-.44284-8.98911-3.43921-8.84148-19.77896,4.97926-23.77411,5.17609-10.33234-6.49947-3.63605-12.83664,12.59061-8.62997,13.54019-9.67798,7.20163-5.36086,12.66373-1.62509,12.45361,3.39133,12.45361,3.39133c0,0,13.13187,2.35669,11.42953,8.44785-1.70233,6.09114,4.88086,17.78137,2.17972,23.92172s-5.15625,17.27464-5.15625,17.27464l.00003-.00003Z"
                fill="#2f2e41"
              />
              <path
                d="M417.93042,619.99091l18,2,2,33s-1,16-18,14-12-18-12-18l10-31Z"
                fill="#2f2e41"
              />
              <path
                d="M441.43042,596.49091s13-6,15,1l4,14s0,14,1,15,20,27,3,41c0,0-9,1-14-13s-20-28-20-28c0,0-2.90552-7,2.04724-6.5s11.95276-11.5,9.95276-15.5-1-8-1-8Z"
                fill="#2f2e41"
              />
              <path
                d="M276.32861,465.84528c-4.65244-1.95972-5.92755-9.47403-2.84735-16.78717,1.19034-2.93823,3.06702-5.54861,5.47299-7.61279l3.59381-8.24313-.12833-.08676,10.33322-41.18274c2.40259-9.5755,9.01791-17.65363,18.10272-21.51736,5.40436-2.29846,10.53253-2.71387,12.02371,2.79303,2.4744,9.13773-13.64221,38.57202-23.35983,55.13284l-7.57083,18.5773c.20474,3.16461-.35153,6.33215-1.62225,9.23752-3.07809,7.311-9.34543,11.6489-13.99786,9.68924v.00003Z"
                fill="#ffb6b6"
              />
              <path
                d="M392.43042,274.49091l33,1,32,14-5,83s6,19,3,22,0,16.44882-2,16.7244,0,14.74017,0,14.74017c0,0-28-9.46457-52-3.46457s-32-4-32-4c0,0-6-24-6-29v-102.24408l29-12.75592Z"
                fill="#62d9c3"
              />
              <path
                d="M368.93042,286.99091s-14-4-21,6-11,10-11,23c0,0-41,58-39,64l-9.5,15.5,24,13s8.5-8.5,8.5-16.5,24-30,24-30c0,0,21-27,22-37s2-38,2-38Z"
                fill="#62d9c3"
              />
              <g>
                <g>
                  <path
                    d="M492.2301,470.94406h137.66882c23.32294,0,42.22998,18.90698,42.22998,42.22995v110.43292c0,23.32294-18.90692,42.22986-42.22986,42.22986h-137.66895c-23.32297,0-42.22995-18.90698-42.22995-42.22998v-110.4328c0-23.32297,18.90698-42.22995,42.22995-42.22995Z"
                    fill="#fff"
                  />
                  <path
                    d="M448,622.6073v-110.43262c0-23.83691,19.39307-43.22998,43.22998-43.22998h137.66895c23.83691,0,43.22998,19.39307,43.22998,43.22998v110.43262c0,23.83691-19.39307,43.22949-43.22998,43.22949h-137.66895c-23.83691,0-43.22998-19.39258-43.22998-43.22949Zm43.22998-151.6626c-22.73438,0-41.22998,18.49561-41.22998,41.22998v110.43262c0,22.73438,18.49561,41.22949,41.22998,41.22949h137.66895c22.73438,0,41.22998-18.49512,41.22998-41.22949v-110.43262c0-22.73438-18.49561-41.22998-41.22998-41.22998h-137.66895Z"
                    fill="#3f3d56"
                  />
                </g>
                <g>
                  <path
                    d="M578.58838,548.15588h3.39716l9.68195-9.68195,.47559-4.1106c-18.01923-15.90442-45.51971-14.19-61.42413,3.82922-4.41785,5.00531-7.62488,10.9599-9.37286,17.40308,1.07861-.44208,2.27344-.51379,3.39716-.20386l19.36389-3.19336s.98517-1.63062,1.49475-1.52875c8.61353-9.4599,23.10938-10.56232,33.05444-2.51392h-.06793v.00012Z"
                    fill="#ea4335"
                  />
                  <path
                    d="M605.46002,555.5957c-2.22546-8.19519-6.79468-15.56262-13.14703-21.19836l-13.58868,13.58868c5.73804,4.68854,9.00653,11.7514,8.86664,19.16003v2.41199c6.67926,0,12.09393,5.41461,12.09393,12.09393s-5.41461,12.09393-12.09393,12.09393h-24.18787l-2.41199,2.44598v14.50592l2.41199,2.41199h24.18787c17.37311,.13525,31.56647-13.83881,31.70172-31.21191,.08197-10.52997-5.11017-20.40253-13.83264-26.30212v-.00006Z"
                    fill="#4285f4"
                  />
                  <path
                    d="M539.18121,612.97388h24.18787v-19.36383h-24.18787c-1.72327-.00037-3.42633-.37109-4.99384-1.0871l-3.39716,1.0531-9.74988,9.68195-.8493,3.39716c5.46753,4.1286,12.13904,6.34845,18.99017,6.31873Z"
                    fill="#34a853"
                  />
                  <path
                    d="M539.18121,550.16022c-17.37335,.10376-31.37311,14.27179-31.26932,31.64514,.05795,9.70142,4.58896,18.83337,12.27914,24.74786l14.03033-14.03033c-6.08691-2.75006-8.79193-9.91376-6.04187-16.00067s9.91376-8.79193,16.00067-6.04187c2.68201,1.21173,4.8302,3.35986,6.04187,6.04187l14.03033-14.03033c-5.96954-7.80408-15.24573-12.36676-25.07111-12.33173l-.00006,.00006Z"
                    fill="#fbbc05"
                  />
                </g>
              </g>
              <g>
                <path
                  d="M477.51343,488.47376c5.04141-.2644,8.79111-6.89993,8.37576-14.8244-.1225-3.16782-1.00183-6.26019-2.56442-9.01843l-.58286-8.97357,.15015-.03806,4.25714-42.24536c.98984-9.82257-2.49115-19.66641-9.72543-26.38412-4.3035-3.99622-8.9863-6.12744-12.258-1.45349-5.4288,7.75558-.25851,40.91263,3.26172,59.78857l.8165,20.04413c-1.26663,2.90726-1.81842,6.07562-1.60916,9.23981,.41412,7.92175,4.83722,14.12921,9.8786,13.8649v.00003Z"
                  fill="#ffb6b6"
                />
                <path
                  d="M451.1095,288.80698s14.52661,.98889,17.71722,12.77109,6.95319,13.13974,2.54111,25.36813c0,0,18.88181,68.47244,14.96417,73.43756l3.67557,17.80423-26.98758,4.08301s-5.11066-10.88031-2.39554-18.40546-12.39377-36.36475-12.39377-36.36475c0,0-10.59-32.52463-8.13675-42.27048s11.01556-36.42331,11.01556-36.42331v-.00003Z"
                  fill="#62d9c3"
                />
              </g>
            </svg>
          </div>
          {/* END OF TOP STORAGE BUCKETS SVG */}
        </div>
      </section>
    </>
  );
